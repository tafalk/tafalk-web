<template>
  <v-dialog v-model="getIsFlagDialogVisible" persistent max-width="600">
    <v-stepper v-model="flagCurrentStep">
      <v-stepper-header>
        <v-stepper-step :complete="flagCurrentStep > 1" step="1">{{
          $t('flag.dialog.steps.category.stepName')
        }}</v-stepper-step>
        <v-divider></v-divider>
        <v-stepper-step step="2">{{
          $t('flag.dialog.steps.type.stepName')
        }}</v-stepper-step>
      </v-stepper-header>
      <v-stepper-items>
        <!-- Step 1 content -->
        <v-stepper-content step="1">
          <v-subheader class="grey--text">{{
            $t('flag.dialog.steps.category.header')
          }}</v-subheader>
          <v-list two-line>
            <v-list-item :disabled="isSelectedCategorySpam">
              <v-list-item-content @click="onClickCategory(spamCategoryValue)">
                <v-list-item-title>{{
                  $t('flag.dialog.steps.category.options.spam.header')
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.category.options.spam.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
              <v-list-item-action v-if="isSelectedCategorySpam">
                <v-icon :color="selectedOptionIndicatorColor"
            ...
            <v-list-item :disabled="isSelectedCategoryRude">
              <v-list-item-content @click="onClickCategory(rudeCategoryValue)">
                <v-list-item-title>{{
                  $t('flag.dialog.steps.category.options.rude.header')
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.category.options.rude.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
            ...
            <v-list-item :disabled="isSelectedCategoryLowQuality">
              <v-list-item-content
                @click="onClickCategory(lowQualityCategoryValue)"
              >
                <v-list-item-title>{{
                  $t('flag.dialog.steps.category.options.lowQuality.header')
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.category.options.lowQuality.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
          ...
          <v-container>
            <v-row justify="space-between">
              <v-btn aria-label="Cancel" text @click="onCancelFlagBtnClick"
        ...
        <v-stepper-content step="2">
          ...
          <template v-if="isSelectedCategorySpam">
            <v-subheader class="grey--text">{{
              $t('flag.dialog.steps.type.spam.header')
            }}</v-subheader>
            <v-list two-line>
              <v-list-item :disabled="isSelectedSpamDetailAd">
                <v-list-item-content
                  @click="onClickSpamDetail(spamAdDetailValue)"
                >
                  <v-list-item-subtitle>{{
                    $t('flag.dialog.steps.type.spam.options.ad.detail')
                  }}</v-list-item-subtitle>
                </v-list-item-content>
              ...
              <v-list-item :disabled="isSelectedSpamDetailHarmfulLink">
                <v-list-item-content
                  @click="onClickSpamDetail(spamHarmfulLinkDetailValue)"
                >
                  <v-list-item-subtitle>{{
                    $t('flag.dialog.steps.type.spam.options.harmful.detail')
                  }}</v-list-item-subtitle>
                </v-list-item-content>
          ...
          <template v-else-if="isSelectedCategoryRude">
            <v-list-item :disabled="isSelectedRudeDetailHate">
              <v-list-item-content
                @click="onClickRudeDetail(rudeHateDetailValue)"
              >
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.type.rude.options.hate.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
            ...
            <v-list-item :disabled="isSelectedRudeDetailThreat">
              <v-list-item-content
                @click="onClickRudeDetail(rudeThreatDetailValue)"
              >
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.type.rude.options.threat.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
            ...
            <v-list-item :disabled="isSelectedRudeDetailOffensive">
              <v-list-item-content
                @click="onClickRudeDetail(rudeOffensiveDetailValue)"
              >
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.type.rude.options.offensive.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
            ...
            <v-list-item :disabled="isSelectedRudeDetailPrivate">
              <v-list-item-content
                @click="onClickRudeDetail(rudePrivateDetailValue)"
              >
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.type.rude.options.private.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
          ...
          <template v-else>
            <v-list-item>
              <v-list-item-content>
                <v-list-item-subtitle>{{
                  $t('flag.dialog.steps.type.lowQuality.options.default.detail')
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </template>
          ...
          <v-container>
            <v-row justify="space-between">
              <v-btn aria-label="Previous" text @click="flagCurrentStep = 1"
