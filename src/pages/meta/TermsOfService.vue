...
<div>
  <v-card flat>
    <v-card-title class="display-1 font-weight-bold">{{ $t('agreements.termsOfService.title') }}</v-card-title>
...
export default {
  ...
  created () {
    ...
    this.$httpSitePoliciesStorage.get(`${this.s3TermsOfUseFolder}/${locale}.html`).then(resp => {
