...
export const ListSealedBriefStreams = gql`
  query ListSealedBriefStreams($limit: Int, $nextToken: String) {
...
export const ListLiveBriefStreams = gql`
  query ListLiveBriefStreams($limit: Int, $nextToken: String) {
...
export const SealStreamForEver = gql`
  mutation SealStreamForEver(
    $id: ID!
    $title: String
    $body: String!
    $privacy: StreamPrivacy
...
export const UpdateMood = gql`
  mutation UpdateMood($id: ID!, $mood: [Mood]) {
...
export const UpdatePosition = gql`
  mutation UpdatePosition($id: ID!, $position: [Position]) {
...
// Subscribe
export const OnUpdateStream = gql`
