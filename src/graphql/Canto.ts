...
// Get
export const GetCantoBody = gql`
  query GetCantoBody($id: ID!) {
    getCanto(id: $id) {
      body
    }
  }
...
export const ListBriefCantos = gql`
  query ListBriefCantos($limit: Int, $nextToken: String) {
...
// Mutate
export const CreateCanto = gql`
  mutation CreateCanto(
    $id: ID!
    $body: String
    $startTime: String!
...
// Subscribe
export const OnUpdateCanto = gql`
