...
// Get
export const GetInteractionsBetweenUsers = gql`
  query queryUserInteractionsBetweenUsersByUserIdIndices(
    $actorUserId: String!
    $targetUserId: String!
  ) {
...
export const StopWatchingUser = gql`
  mutation StopWatchingUser($watchId: ID!) {
...
export const UnblockUser = gql`
  mutation UnblockUser($blockId: ID!) {
